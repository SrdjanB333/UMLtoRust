...
def serializedATN():
    return [
        4,1,18,82,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,
        ...
        0,2,4,6,8,10,12,14,16,0,2,1,0,11,13,1,0,2,5,81,0,18,1,0,0,0,2,27,
        1,0,0,0,4,40,1,0,0,0,6,43,1,0,0,0,8,50,1,0,0,0,10,62,1,0,0,0,12,
        64,1,0,0,0,14,77,1,0,0,0,16,79,1,0,0,0,18,20,5,6,0,0,19,21,3,2,1,
        0,20,19,1,0,0,0,21,22,1,0,0,0,22,20,1,0,0,0,22,23,1,0,0,0,23,24,
        1,0,0,0,24,25,5,7,0,0,25,26,5,0,0,1,26,1,1,0,0,0,27,28,5,8,0,0,28,
        29,5,17,0,0,29,33,5,9,0,0,30,32,3,4,2,0,31,30,1,0,0,0,32,35,1,0,
        0,0,33,31,1,0,0,0,33,34,1,0,0,0,34,36,1,0,0,0,35,33,1,0,0,0,36,37,
        5,10,0,0,37,3,1,0,0,0,38,41,3,6,3,0,39,41,3,8,4,0,40,38,1,0,0,0,
        40,39,1,0,0,0,41,5,1,0,0,0,42,44,3,10,5,0,43,42,1,0,0,0,43,44,1,
        0,0,0,44,45,1,0,0,0,45,46,5,17,0,0,46,47,5,1,0,0,47,48,3,16,8,0,
        48,7,1,0,0,0,49,51,3,10,5,0,50,49,1,0,0,0,50,51,1,0,0,0,51,52,1,
        0,0,0,52,53,5,17,0,0,53,55,5,14,0,0,54,56,3,14,7,0,55,54,1,0,0,0,
        55,56,1,0,0,0,56,57,1,0,0,0,57,60,5,15,0,0,58,59,5,1,0,0,59,61,3,
        16,8,0,60,58,1,0,0,0,60,61,1,0,0,0,61,9,1,0,0,0,62,63,7,0,0,0,63,
        11,1,0,0,0,64,65,5,17,0,0,65,66,5,1,0,0,66,67,3,16,8,0,67,13,1,0,
        0,0,68,78,3,12,6,0,69,74,3,12,6,0,70,71,5,16,0,0,71,73,3,12,6,0,
        72,70,1,0,0,0,73,76,1,0,0,0,74,72,1,0,0,0,74,75,1,0,0,0,75,78,1,
        0,0,0,76,74,1,0,0,0,77,68,1,0,0,0,77,69,1,0,0,0,78,15,1,0,0,0,79,
        80,7,1,0,0,80,17,1,0,0,0,9,22,33,40,43,50,55,60,74,77
    ]
...
class PlantUMLParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "':'", "'String'", "'int'", "'bool'", 
                     "'float'", "'@startuml'", "'@enduml'", "'class'", "'{'", 
                     "'}'", "'+'", "'-'", "'#'", "'('", "')'", "','" ]

    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "STARTUML", "ENDUML", "CLASS", 
    ...
    def classDeclaration(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 145408) != 0):
                self.state = 30
                self.member()
                self.state = 35
                self._errHandler.sync(self)
